...
Revision ID: 9a32486feca0
Revises: 
Create Date: 2024-04-10 23:00:17.050217
...
def upgrade():
    ...
    sa.Column('bursary_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['student_id'], ['studentdetails.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('student_id', sa.UUID(), nullable=False),
    sa.Column('parent', sa.String(length=100), nullable=False),
    ...
    sa.Column('employment_status', postgresql.ENUM('yes', 'no', 'retired', 'self_employed', name='employmentstatusenum'), nullable=False),
    sa.ForeignKeyConstraint(['student_id'], ['studentdetails.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
